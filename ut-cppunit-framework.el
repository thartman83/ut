...
(defun ut-cppunit-setup-new-test-suite (test-suite conf)
  ...
  (let* ((name (ut-test-suite-name test-suite))
         ...
         (top-makefile.am-text (ut-format (ut-format cppunit-default-top-makefile.am test-suite) conf))
         (src-makefile.am-text (ut-format (ut-format cppunit-default-src-makefile.am test-suite) conf))
         (mainfile-text (ut-format (ut-format cppunit-default-mainfile test-suite) conf))
         (testheader-text (ut-format (ut-format cppunit-default-testheader test-suite) conf))
...
(defvar cppunit-default-top-makefile.am
  "SUBDIRS = src")
...
(defvar cppunit-default-mainfile
...
(defvar cppunit-default-testheader
